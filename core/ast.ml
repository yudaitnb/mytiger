...
type exp =
  | Int of    { value : int; pos : position [@equal fun _ _ -> true]; }
  | Bool of   { value : bool; pos : position [@equal fun _ _ -> true]; }
  | String of { value : string; pos : position [@equal fun _ _ -> true]; }
  | Var of    { name : name; pos : position [@equal fun _ _ -> true]; }
  | BinOp of  { op : binop; e1 : exp; e2 : exp; pos : position [@equal fun _ _ -> true]; }
  | UnOp  of  { op : unop; e : exp; pos : position [@equal fun _ _ -> true]; }
  ...
  (* レコード *)
  | Nil       of { pos : position [@equal fun _ _ -> true]; }
